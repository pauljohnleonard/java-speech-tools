 ...
 *
 */
public class SimpleViewer1 extends WindowAdapter implements CaptureCallback{
        //private static int      width = 640, height = 480, std = V4L4JConstants.STANDARD_WEBCAM, channel = 0;
	    private static int      width = 600, height = 480, std = V4L4JConstants.STANDARD_WEBCAM, channel = 0;
